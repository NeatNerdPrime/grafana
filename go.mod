...
require (
	...
	github.com/go-openapi/strfmt v0.26.1 // @grafana/alerting-squad-backend
	...
	github.com/magefile/mage v1.17.1 // @grafana/grafana-delivery
	...
	golang.org/x/exp v0.0.0-20260112195511-716be5621a96 // @grafana/alerting-squad-backend
...
require (
	...
	github.com/olekukonko/tablewriter v1.1.4 // @grafana/backend-platform
...
require (
	...
	github.com/getkin/kin-openapi v0.134.0 // @grafana/grafana-operator-experience-squad
	...
	go.opentelemetry.io/contrib/propagators/jaeger v1.42.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.42.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.42.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/contrib/samplers/jaegerremote v0.36.0 // @grafana/backend-platform
